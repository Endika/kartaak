...
export const eu: Record<string, string> = {
  ...
  'home.studyQuickPlay': '{name} ikasi',
  ...
  'settings.sounds.heading': 'Soinuak',
  'settings.sounds.hint': 'Feedback sotila txartela baloratzean.',
  'settings.sounds.toggle': 'Berrikusterakoan soinuak jo',
  ...
  'studyDetail.actions.studyHint': '{learned} / {total} ikasita · %{pct}',
  'studyDetail.actions.empty': 'Oraindik ez dago txartelik. Gehitu batzuk hasteko.',
  'studyDetail.actions.addMore': '+ Gehiago gehitu',
  'studyDetail.actions.export': '📤 Esportatu',
  'studyDetail.actions.delete': '🗑 Ezabatu',
  'studyDetail.actions.dedupe': '🧹 Bikoiztuak garbitu',
  'studyDetail.dedupe.modalTitle': 'Txartel bikoiztuak ezabatu?',
  'studyDetail.dedupe.summary':
    '<strong>{duplicates}</strong> txartel bikoiztu aurkitu dira {groups} taldetan. Talde bakoitzeko aurrerapen handiena duen txartela mantenduko da; gainerakoak ezabatuko dira.',
  'studyDetail.dedupe.empty': 'Ez dago bikoizturik ikasketa honetan.',
  'studyDetail.dedupe.confirm': 'Bikoiztuak ezabatu',
  'studyDetail.dedupe.busy': 'Ezabatzen…',
  'studyDetail.dedupe.done': '{removed} bikoiztu ezabatu dira. {kept} txartel mantendu dira.',
